...
scalar values. This definition has no practical value (it is covered by
more general array portals in the Dax toolkit), but demonstrates the
...
public:
  ...
  DAX_EXEC_CONT_EXPORT
  dax::Id GetNumberOfValues GetNumberOfValues() const { return this->GetNumberOfValues; }
