...
\begin{daxexample}[ex:DerivedArrayContainer]{\textidentifier{ArrayContainerControl} for derived container.}
template<typename FirstArrayHandleType, typename SecondArrayHandleType>
...
public:
  ...
  typedef ArrayPortalConcatinate<
      typename ArrayHandleType1::PortalConstType,
      typename ArrayHandleType2::PortalConstType> PortalType;
